...
if ($env:APPVEYOR_REPO_TAG -eq $true) {
	...
	exec { & dotnet pack .\src\MotiNet.ComponentModel.Annotations -c Release -o ..\..\artifacts }
	...
	exec { & dotnet pack .\src\MotiNet.ComponentModel.Annotations -c Release -o ..\..\artifacts --version-suffix=$suffix }
